                    ...
                    <div class="col-lg-3 footer_col">
                        <div class="footer_links">
                            ...
                            <ul>
                                ...
                                <li><a href="login.php" onclick="alert('Please come login')">Personal</a></li>
                                <li><a href="login.php" onclick="alert('Please come login')">Transfer</a></li>
                                <li><a href="login.php" onclick="alert('Please come login')">History</a></li>
